...
// its own. `business.context` is loaded through the server caller; a business the user is not an
// active member of (or none at all) is "not found". The (app) layout handles an ended session.
