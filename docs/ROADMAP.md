...
Estimate: **~9–11 weeks solo**. Step 0 is IN PROGRESS (0a and local 0b done). Step 1 is DONE. Step 2 code is DONE; its Vercel deploy is BLOCKED on owner accounts. All other steps are PLANNED.
