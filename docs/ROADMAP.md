...
Estimate: **~9–11 weeks solo**. Step 0 is IN PROGRESS (0a done). All other steps are PLANNED.
...
| Resend + DNS SPF/DKIM/DMARC | Before any real user | Auth mail and notifications on separate subdomains                                                                                                        |
| Sentry                      | Step 2               | Cost values are redacted in telemetry                                                                                                                     |
| Docker Desktop (WSL2)       | Step 0               | If it is too heavy: hosted dev project, decided on day 1                                                                                                  |
...
| Local Docker vs hosted dev project                                                                                                                                                    | Step 0, day 1                                    |                                                                                                                                                    |
| Identity-table policy predicates; how co-members' names are read; capabilities that mirror a `businesses` column (e.g. `vat_registered`) stored once                                  | Step 1                                           | DATA_MODEL.md §2, §4                                                                                                                               |
| Meaning of an empty member location set (proposal: all locations)                                                                                                                     | Step 2                                           | DATA_MODEL.md §4                                                                                                                                   |
| Arabic UI tone: MSA vs the owner's Gulf wording in Smart Setup                                                                                                                        | Step 5                                           | PRODUCT.md §13                                                                                                                                     |
