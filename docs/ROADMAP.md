...
Estimate: **~9–11 weeks solo**. Step 0 is IN PROGRESS (0a and local 0b done). Step 1 is DONE. Step 2 code is DONE; its Vercel deploy is BLOCKED on owner accounts. Step 3 is DONE (local; hosted settings follow the Step 0b/2 deploy). Step 4 is deferred by the owner. Step 5 is DONE. All other steps are PLANNED.
